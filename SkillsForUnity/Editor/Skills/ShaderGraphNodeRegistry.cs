    ...
    internal static class ShaderGraphNodeRegistry
    {
        private static readonly IReadOnlyList<ShaderGraphSupportedNodeDescriptor> Descriptors =
            new[]
            {
                ...
                // 数学节点组：类名与命名空间取自 com.unity.shadergraph@14.0.12 的
                // Editor/Data/Nodes/Math/ 源码，非凭记忆推断；是否真正可用仍由运行时类型解析过滤。
                Create("LengthNode", "UnityEditor.ShaderGraph.LengthNode"),
                Create("ExponentialNode", "UnityEditor.ShaderGraph.ExponentialNode",
                    notes: "Defaults to base e; set the 'base' setting to switch between BaseE and Base2.",
                    settings: Setting("base", "enum", options: new[] { "BaseE", "Base2" })),
                Create("PowerNode", "UnityEditor.ShaderGraph.PowerNode"),
                Create("SquareRootNode", "UnityEditor.ShaderGraph.SquareRootNode"),
                Create("MaximumNode", "UnityEditor.ShaderGraph.MaximumNode"),
                Create("MinimumNode", "UnityEditor.ShaderGraph.MinimumNode"),
                Create("AbsoluteNode", "UnityEditor.ShaderGraph.AbsoluteNode"),
                Create("NegateNode", "UnityEditor.ShaderGraph.NegateNode"),
                Create("NormalizeNode", "UnityEditor.ShaderGraph.NormalizeNode"),
                Create("DotProductNode", "UnityEditor.ShaderGraph.DotProductNode"),
                Create("SmoothstepNode", "UnityEditor.ShaderGraph.SmoothstepNode"),
                Create("StepNode", "UnityEditor.ShaderGraph.StepNode"),
